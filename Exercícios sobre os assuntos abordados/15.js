 ...
 * “Compra efetuada com sucesso”. Nas outras opções, retorne: “Tem certeza que não prefere este modelo?”. 
 * Caso seja especificado um modelo que não está disponível, retorne no console:
 * “Não trabalhamos com este tipo de automóvel aqui”.
 * 
*/

function revendedoraDeCarro(transporte) {
	switch(transporte) {
		case "hatch":
...
console.log(revendedoraDeCarro("hatch"));
console.log(revendedoraDeCarro("sedans"));
console.log(revendedoraDeCarro("motocicletas"));
console.log(revendedoraDeCarro("caminhonetes"));
console.log(revendedoraDeCarro("jetski"));