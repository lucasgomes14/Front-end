 ...
 * como 0.30000000000000004 e retorne R$0,30 (observe a vírgula 
 * e o ponto).
 * 
*/

function dinheiroArredondado(valor) {
	return `R$${valor.toFixed(2).toString().replace(".", ",")}`;
}

console.log(dinheiroArredondado(0.3000000));
console.log(dinheiroArredondado(0.1 + 0.2));